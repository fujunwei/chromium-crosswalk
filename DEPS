...
deps = {
  ...
  'build/scripts/tools/deps2git':
    '/trunk/tools/deps2git@292856',
  'build/third_party/lighttpd':
    '/trunk/deps/third_party/lighttpd@58968',
  'depot_tools':
    '/trunk/tools/depot_tools@295275',
  'src/breakpad/src':
    (Var("git.chromium.org")) + '/external/google-breakpad/src.git@9fcbe255a64d39295ad5f1f15c0b92db3da83c0f',
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@b73e5f70d7ac6be98fb2555461f631afc90216ce',
  ...
  'src/media/cdm/ppapi/api':
    (Var("git.chromium.org")) + '/chromium/cdm.git@7377023e384f296cbb27644eb2c485275f1f92e8',
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@862ca265aa1fdcabe8b3ab518251381bfbf48468',
  'src/sdch/open-vcdiff':
    (Var("git.chromium.org")) + '/external/open-vcdiff.git@438f2a5be6d809bc21611a94cd37bfc8c28ceb33',
  'src/testing/gmock':
    (Var("git.chromium.org")) + '/external/googlemock.git@29763965ab52f24565299976b936d1265cb6a271',
  'src/testing/gtest':
    (Var("git.chromium.org")) + '/external/googletest.git@23574bf2333f834ff665f894c97bef8a5b33a0a9',
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@b2c74fa56e9c92b44aa4bc21175ab361d8bdc276',
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@21ce9b02de90b81d3c3fab95f02ad45fbffd7350',
  'src/third_party/bidichecker':
    (Var("git.chromium.org")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@a07c0fc8f2181d086b1118712e2ceb0d1496fa0b',
  'src/third_party/cacheinvalidation/src':
    (Var("git.chromium.org")) + '/external/google-cache-invalidation-api/src.git@0fbfe801cca467fa986ebe08d34012342aa47e55',
  'src/third_party/cld_2/src':
    (Var("git.chromium.org")) + '/external/cld2.git@14d9ef8d4766326f8aa7de54402d1b9c782d4481',
  ...
  'src/third_party/crashpad/crashpad':
    (Var("git.chromium.org")) + '/crashpad/crashpad.git@00c42ae7bdcf40d15c02b87e088c1eb565a51333',
  'src/third_party/dom_distiller_js/dist':
    (Var("git.chromium.org")) + '/external/github.com/chromium/dom-distiller-dist.git@4948eb81dc84578e58a59b8ef493ce946cd00b0f',
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@c0f05636c4472e5d3c0045ec34464aec46c5fb70',
  'src/third_party/flac':
    (Var("git.chromium.org")) + '/chromium/deps/flac.git@0635a091379d9677f1ddde5f2eec85d0f096f219',
  'src/third_party/hunspell_dictionaries':
    (Var("git.chromium.org")) + '/chromium/deps/hunspell_dictionaries.git@80796932b89ab36431399d76c5b8391ea471e30a',
  'src/third_party/icu':
    (Var("git.chromium.org")) + '/chromium/deps/icu.git@5788e2736b3bc642994b6351a6096124895afa01',
  'src/third_party/jsoncpp/source':
    (Var("git.chromium.org")) + '/external/github.com/open-source-parsers/jsoncpp.git@f572e8e42e22cfcf5ab0aea26574f408943edfa4',
  'src/third_party/leveldatabase/src':
    (Var("git.chromium.org")) + '/external/leveldb.git@251ebf5dc70129ad3c38193fe6c99a5b0ec6b9fa',
  'src/third_party/libaddressinput/src':
    (Var("git.chromium.org")) + '/external/libaddressinput.git@61f63da7ae6fa469138d60dec5d6bbecc6ab43d6',
  'src/third_party/libexif/sources':
    (Var("git.chromium.org")) + '/chromium/deps/libexif/sources.git@ed98343daabd7b4497f97fda972e132e6877c48a',
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@479b5d7e1a4e95510ecc3452f8229e3428bd5a6d',
  'src/third_party/libjpeg_turbo':
    (Var("git.chromium.org")) + '/chromium/deps/libjpeg_turbo.git@8ee9bdd068effcf5fe876e401829eadb94569750',
  'src/third_party/libphonenumber/src/phonenumbers':
    (Var("git.chromium.org")) + '/external/libphonenumber/cpp/src/phonenumbers.git@0d6e3e50e17c94262ad1ca3b7d52b11223084bca',
  'src/third_party/libphonenumber/src/resources':
    (Var("git.chromium.org")) + '/external/libphonenumber/resources.git@b6dfdc7952571ff7ee72643cd88c988cbe966396',
  'src/third_party/libphonenumber/src/test':
    (Var("git.chromium.org")) + '/external/libphonenumber/cpp/test.git@f351a7e007f9c9995494499120bbc361ca808a16',
  'src/third_party/libsrtp':
    (Var("git.chromium.org")) + '/chromium/deps/libsrtp.git@9c53f858cddd4d890e405e91ff3af0b48dfd90e6',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@d1c022c097f22987d521643c4802b623e572393a',
  'src/third_party/libyuv':
    (Var("git.chromium.org")) + '/external/libyuv.git@35aa92a1ea1bbcca6bf97e69e7a65f1caa987675',
  'src/third_party/mesa/src':
    (Var("git.chromium.org")) + '/chromium/deps/mesa.git@071d25db04c23821a12a8b260ab9d96a097402f0',
  'src/third_party/openmax_dl':
    (Var("git.chromium.org")) + '/external/webrtc/deps/third_party/openmax.git@22bb1085a6a0f6f3589a8c3d60ed0a9b82248275',
  'src/third_party/opus/src':
    (Var("git.chromium.org")) + '/chromium/deps/opus.git@cae696156f1e60006e39821e79a1811ae1933c69',
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@f33cdd54d5d5340d8a662048d9cf4abe7d5f0488',
  'src/third_party/py_trace_event/src':
    (Var("git.chromium.org")) + '/external/py_trace_event.git@dd463ea9e2c430de2b9e53dea57a77b4c3ac9b30',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@465706820d0d373f76ab4831c286115ee0d86b7a',
  ...
  'src/third_party/trace-viewer':
    (Var("git.chromium.org")) + '/external/trace-viewer.git@e2b5374c4941c450b168d4c7d9110fb91b2d4c19',
  'src/third_party/usrsctp/usrsctplib':
    (Var("git.chromium.org")) + '/external/usrsctplib.git@36444a999739e9e408f8f587cb4c3ffeef2e50ac',
  'src/third_party/webdriver/pylib':
    (Var("git.chromium.org")) + '/external/selenium/py.git@5fd78261a75fe08d27ca4835fb6c5ce4b42275bd',
  'src/third_party/webgl/src':
    (Var("git.chromium.org")) + '/external/khronosgroup/webgl.git@1e318b3f0ad952d22477151eec98d37fa08e5bc7',
  'src/third_party/webpagereplay':
    (Var("git.chromium.org")) + '/external/github.com/chromium/web-page-replay.git@e53550b73e8e098938a651bc8ceb3681e5980567',
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@5f1140b58f0104caa4acbe528938cb5d06c8445c',
  'src/third_party/yasm/source/patched-yasm':
    (Var("git.chromium.org")) + '/chromium/deps/yasm/patched-yasm.git@4671120cd8558ce62ee8672ebf3eb6f5216f909b',
  'src/tools/deps2git':
    (Var("git.chromium.org")) + '/chromium/tools/deps2git.git@f04828eb0b5acd3e7ad983c024870f17f17b06d9',
  'src/tools/grit':
    (Var("git.chromium.org")) + '/external/grit-i18n.git@c1b1591a05209c1ad467e845ba8543c22f9072af',
  'src/tools/gyp':
    (Var("git.chromium.org")) + '/external/gyp.git@0bb67471bca068996e15b56738fa4824dfa19de0',
  'src/tools/page_cycler/acid3':
    (Var("git.chromium.org")) + '/chromium/deps/acid3.git@6be0a66a1ebd7ebc5abc1b2f405a945f6d871521',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@b39a448d8522392389b28f6997126a6ab04bfe87',
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@9ab46d78f28ac048b05edb24766b942132c923b4'
}
...
deps_os = {
  'android': {
    ...
    'src/third_party/android_tools':
      (Var("git.chromium.org")) + '/android_tools.git@3445d55bd6a9bedd04ecd9deabc9071fa5b93ca1',
    'src/third_party/apache-mime4j':
      (Var("git.chromium.org")) + '/chromium/deps/apache-mime4j.git@28cb1108bff4b6cf0a2e86ff58b3d025934ebe3a',
    'src/third_party/appurify-python/src':
      (Var("git.chromium.org")) + '/external/github.com/appurify/appurify-python.git@ee7abd5c5ae3106f72b2a0b9d2cb55094688e867',
    ...
    'src/third_party/freetype':
      (Var("git.chromium.org")) + '/chromium/src/third_party/freetype.git@3165210e3e3f5d93f27b6872fbb122cbfc7b33ce',
    ...
    'src/third_party/lss':
      (Var("git.chromium.org")) + '/external/linux-syscall-support/lss.git@6f97298fe3794e92c8c896a6bc06e0b36e4c3de3',
    ...
    'src/third_party/robolectric/lib':
      (Var("git.chromium.org")) + '/chromium/third_party/robolectric.git@6b63c99a8b6967acdb42cbed0adb067c80efc810'
  },
  'ios': {
    'src/chrome/test/data/perf/canvas_bench': None,
    'src/chrome/test/data/perf/frame_rate/content': None,
    'src/ios/third_party/gcdwebserver/src':
      (Var("git.chromium.org")) + '/external/github.com/swisspol/GCDWebServer.git@18889793b75d7ee593d62ac88997caad850acdb6',
    'src/native_client': None,
    'src/testing/iossim/third_party/class-dump':
      (Var("git.chromium.org")) + '/chromium/deps/class-dump.git@89bd40883c767584240b4dade8b74e6f57b9bdab',
    'src/third_party/ffmpeg': None,
    'src/third_party/google_toolbox_for_mac/src':
      (Var("git.chromium.org")) + '/external/google-toolbox-for-mac.git@ce47a231ea0b238fbe95538e86cc61d74c234be6',
    'src/third_party/hunspell_dictionaries': None,
    'src/third_party/nss':
      (Var("git.chromium.org")) + '/chromium/deps/nss.git@95068068df410e398ac221a9195c999b22bd63e9',
  ...
  'unix': {
    ...
    'src/third_party/chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@c9bfb471ec08e85d0c8baa35341403013153956c',
    'src/third_party/cros_system_api':
      (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@f2d7a9a97171f25419ff4294b1dba41302981fa2',
    'src/third_party/fontconfig/src':
      (Var("git.chromium.org")) + '/external/fontconfig.git@f16c3118e25546c1b749f9823c51827a60aeb5c1',
    'src/third_party/freetype2/src':
      (Var("git.chromium.org")) + '/chromium/src/third_party/freetype2.git@1dd5f5f4a909866f15c92a45c9702bce290a0151',
  ...
  'win': {
    ...
    'src/third_party/omaha/src/omaha':
      (Var("git.chromium.org")) + '/external/omaha.git@098c7a3d157218dab4eed595e8f2fbe5a20a0bae',
